...
model.save_model('autoencoder_20m.model')
model.load_model('autoencoder_20m.model')
model.evaluate(ml_ds_test, 'movielens_20m_preds.txt')
model.cal_RMSE("movielens_20m_preds.txt")
