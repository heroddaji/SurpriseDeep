...
ml_option = DatasetOption(root_dir='ds_movielens', ds_name='26m', save_dir='26m')
ml_ds_train = Movielens(ml_option)
ml_ds_train.download_and_process_data()
ml_ds_test = Movielens(ml_option, train=False)

model_option = ModelOption(root_dir="recsys_deeplearning", save_dir="autoencoder_26m")
...
model.save_model('autoencoder_26m.model')
model.load_model('autoencoder_26m.model')
model.evaluate(ml_ds_test, 'movielens_26m_preds.txt')
model.cal_RMSE("movielens_26m_preds.txt")
