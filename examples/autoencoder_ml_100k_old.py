...
if not pre_train:
    ml_option_100k = DatasetOption(root_dir='ds_movielens', ds_name='100k_old', save_dir='100k_old')
    ...
    model_option_100k = ModelOption(root_dir="recsys_deeplearning", save_dir="autoencoder_100k_old")
